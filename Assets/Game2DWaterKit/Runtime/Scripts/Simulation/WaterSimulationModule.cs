namespace Game2DWaterKit.Simulation
{
    ...
    public class WaterSimulationModule
    {
        ...
        public float Spread { get => _spread;
            set => _spread = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        ...
        public float LeftBoundary => _isUsingCustomBoundaries ? LeftCustomBoundary : _mainModule.Width * -0.5f;
        public float RightBoundary => _isUsingCustomBoundaries ? RightCustomBoundary : _mainModule.Width * 0.5f;
        public float MaximumDynamicWavesDisturbance { get => _maximumdDynamicWavesDisturbance;
            set => _maximumdDynamicWavesDisturbance = value;
        }
        public bool LimitDynamicWavesDisturbance { get => _limitDynamicWavesDisturbance;
            set => _limitDynamicWavesDisturbance = value;
        }
        public bool AreSineWavesActive { get => _areSineWavesActive;
            set => _areSineWavesActive = value;
        }
        public List<WaterSimulationSineWaveParameters> SineWavesParameters { get => _sineWavesParameters;
            set => _sineWavesParameters = value;
        }
        public bool CanWavesAffectRigidbodies { get => _canWavesAffectRigidbodies;
            set => _canWavesAffectRigidbodies = value;
        }
        public float WavesStrengthOnRigidbodies { get => _wavesStrengthOnRigidbodies;
            set => _wavesStrengthOnRigidbodies = value;
        }
        internal int SineWavesOffset { get; set; }
        internal WaterMainModule MainModule => _mainModule;
        internal float[] DynamicWavesVelocities => _dynamicWavesVelocities;
        internal float LeftCustomBoundary => Mathf.Clamp(_leftCustomBoundary, -_mainModule.Width * 0.5f, _mainModule.Width * 0.5f);
        internal float RightCustomBoundary => Mathf.Clamp(_rightCustomBoundary, -_mainModule.Width * 0.5f, _mainModule.Width * 0.5f);
        ...
        internal float SurfaceHeighestPoint => _mainModule.Height * 0.5f + _surfaceHeighestPointDeltaHeight;
        private float LastSurfaceVertexDynamicWavesPositionHeight => _dynamicWavesPositions[_meshModule.SurfaceVerticesCount - 1];
        private float SecondSurfaceVertexDynamicWavesPositionHeight => _dynamicWavesPositions[1];
