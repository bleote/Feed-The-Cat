namespace Game2DWaterKit.Ripples
{
    ...
    public class WaterCollisionRipplesModule
    {
        ...
        #region Properties
        public bool IsOnWaterEnterRipplesActive { get => _isOnWaterEnterRipplesActive;
            set => _isOnWaterEnterRipplesActive = value;
        }
        public bool IsOnWaterExitRipplesActive { get => _isOnWaterExitRipplesActive;
            set => _isOnWaterExitRipplesActive = value;
        }
        public bool IsOnWaterMoveRipplesActive { get => _isOnWaterMoveRipplesActive;
            set => _isOnWaterMoveRipplesActive = value;
        }
        public bool CollisionIgnoreTriggers { get => _collisionIgnoreTriggers;
            set => _collisionIgnoreTriggers = value;
        }
        public LayerMask CollisionMask { get => _collisionMask;
            set => _collisionMask = value;
        }
        public float CollisionMaximumDepth { get => _collisionMaximumDepth;
            set => _collisionMaximumDepth = value;
        }
        public float CollisionMinimumDepth { get => _collisionMinimumDepth;
            set => _collisionMinimumDepth = value;
        }
        public float CollisionRaycastMaximumDistance { get => _collisionRaycastMaximumDistance;
            set => _collisionRaycastMaximumDistance = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public float MaximumDisturbance { get => _maximumDisturbance;
            set => _maximumDisturbance = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public float MinimumDisturbance { get => _minimumDisturbance;
            set => _minimumDisturbance = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public float MinimumVelocityToCauseMaximumDisturbance { get => _maximumDisturbance / _velocityMultiplier;
            set { if (value != 0f) VelocityMultiplier = _maximumDisturbance / value; } }
        public float OnWaterMoveRipplesMinimumVelocityToCauseMaximumDisturbance { get => _onWaterMoveRipplesMinimumVelocityToCauseMaximumDisturbance;
            set => _onWaterMoveRipplesMinimumVelocityToCauseMaximumDisturbance = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public float OnWaterMoveRipplesDisturbanceSmoothFactor { get => _onWaterMoveRipplesDisturbanceSmoothFactor;
            set => _onWaterMoveRipplesDisturbanceSmoothFactor = Mathf.Clamp01(value);
        }
        public float OnWaterMoveRipplesMaximumDisturbance { get => _onWaterMoveRipplesMaximumDisturbance;
            set => _onWaterMoveRipplesMaximumDisturbance = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public UnityEvent OnWaterEnter { get => _onWaterEnter;
            set => _onWaterEnter = value;
        }
        public UnityEvent OnWaterExit { get => _onWaterExit;
            set => _onWaterExit = value;
        }
        public static OnWaterEnterExitEvent OnWaterEnterExit { get => _onWaterEnterExit;
            set => _onWaterEnterExit = value;
        }
        public float VelocityMultiplier { get => _velocityMultiplier;
            set => _velocityMultiplier = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public WaterRipplesParticleEffect OnWaterEnterRipplesParticleEffect => _onWaterEnterRipplesParticleEffect;
        public WaterRipplesParticleEffect OnWaterExitRipplesParticleEffect => _onWaterExitRipplesParticleEffect;
        public WaterRipplesSoundEffect OnWaterEnterRipplesSoundEffect => _onWaterEnterRipplesSoundEffect;
        public WaterRipplesSoundEffect OnWaterExitRipplesSoundEffect => _onWaterExitRipplesSoundEffect;
