namespace Game2DWaterKit.Ripples
{
    ...
    public class WaterConstantRipplesModule
    {
        ...
        public bool UpdateWhenOffscreen { get => _updateWhenOffscreen;
            set => _updateWhenOffscreen = value;
        }
        public float Disturbance { get => _disturbance;
            set => _disturbance = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        ...
        public bool RandomizeDisturbance { get => _randomizeDisturbance;
            set => _randomizeDisturbance = value;
        }
        public bool SmoothRipples { get => _smoothRipples;
            set => _smoothRipples = value;
        }
        public float SmoothingFactor { get => _smoothingFactor;
            set => _smoothingFactor = Mathf.Clamp01(value);
        }
        public float TimeInterval { get => _timeInterval;
            set => _timeInterval = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public float MaximumTimeInterval { get => _maximumTimeInterval;
            set => _maximumTimeInterval = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public float MinimumTimeInterval { get => _minimumTimeInterval;
            set => _minimumTimeInterval = Mathf.Clamp(value, 0f, float.MaxValue);
        }
        public bool RandomizeTimeInterval { get => _randomizeTimeInterval;
            set => _randomizeTimeInterval = value;
        }
        public bool RandomizeRipplesSourcePositions
        {
            get => _randomizeRipplesSourcePositions;
            set
            {
        ...
        public int RandomRipplesSourceCount { get => _randomRipplesSourceCount;
            set => _randomRipplesSourceCount = value;
        }
        ...
        public bool AllowDuplicateRipplesSourcePositions { get => _allowDuplicateRipplesSourcePositions;
            set => _allowDuplicateRipplesSourcePositions = value;
        }
        public WaterRipplesSoundEffect SoundEffect => _soundEffect;
        public WaterRipplesParticleEffect ParticleEffect => _particleEffect;
