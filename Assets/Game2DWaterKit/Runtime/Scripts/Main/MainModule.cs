namespace Game2DWaterKit.Main
{
    ...
    public abstract class MainModule
    {
        ...
        internal float ZRotation => _zRotation;
        internal float Depth => _depth;
        internal Vector3 UpDirection => _upDirection;
        internal Vector3 ForwardDirection => _forwardDirection;
        internal bool IsVisible { get; set; }
        internal int GameobjectLayer => _gameobjectLayer;
