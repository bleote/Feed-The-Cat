namespace Game2DWaterKit.Rendering
{
    ...
    public abstract class RenderingModule
    {
        ...
        #region Properties
        public bool AllowHDR { get => _allowHDR;
            set => _allowHDR = value;
        }
        public bool AllowMSAA { get => _allowMSAA;
            set => _allowMSAA = value;
        }
        public float FarClipPlane { get => _farClipPlane;
            set => _farClipPlane = Mathf.Clamp(value, 0.001f, float.MaxValue);
        }
        public bool RenderPixelLights { get => _renderPixelLights;
            set => _renderPixelLights = value;
        }
        ...
        public MeshMask MeshMask => _meshMask;
