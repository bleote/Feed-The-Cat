namespace Game2DWaterKit.Rendering
{
    ...
    public class WaterRenderingMode
    {
        ...
        #region Properties
        public float ViewingFrustumHeightScalingFactor { get => _viewingFrustumHeightScalingFactor;
            set => _viewingFrustumHeightScalingFactor = Mathf.Clamp(value,-0.999f,float.MaxValue);
        }
        public float RenderTextureResizingFactor { get => _renderTextureResizingFactor;
            set => _renderTextureResizingFactor = Mathf.Clamp01(value);
        }
        public bool RenderTextureUseFixedSize { get => _renderTextureUseFixedSize;
            set => _renderTextureUseFixedSize = value;
        }
        public int RenderTextureFixedSize { get => _renderTextureFixedSize;
            set => _renderTextureFixedSize = Mathf.Clamp(value, 1, int.MaxValue);
        }
        public LayerMask CullingMask { get => _cullingMask;
            set => _cullingMask = value;
        }
        public FilterMode RenderTextureFilterMode
        {
            get => _renderTextureFilterMode;
            set
            {
