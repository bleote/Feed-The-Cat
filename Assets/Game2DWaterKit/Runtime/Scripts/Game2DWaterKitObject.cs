namespace Game2DWaterKit
{
    ...
    public abstract class Game2DWaterKitObject : MonoBehaviour
    {
        ...
        [SerializeField] protected bool _meshMaskIsActive;
        ...
        [SerializeField] protected bool _meshMaskArePositionAndSizeLocked;
        ...
        public bool IsInitialized => _areModulesInitialized;
