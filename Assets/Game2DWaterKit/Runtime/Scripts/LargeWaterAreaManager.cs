namespace Game2DWaterKit
{
    ...
    public class LargeWaterAreaManager : MonoBehaviour
    {
        ...
        [SerializeField] private float _constrainedRegionXMin;
        [SerializeField] private float _constrainedRegionXMax;
        ...
        public Game2DWater WaterObject { get => _waterObject;
            set => _waterObject = value;
        }
        public int WaterObjectCount { get => _waterObjectCount;
            set => _waterObjectCount = Mathf.Clamp(value, 2, int.MaxValue);
        }
        public bool IsConstrained => _isConstrained;
        public float ConstrainedRegionXMin => _constrainedRegionXMin;
        public float ConstrainedRegionXMax => _constrainedRegionXMax;
        ...
        internal HashSet<Collider2D> InWaterColliders => _inWaterColliders;
