namespace Game2DWaterKit.Material
{
    ...
    public class WaterMaterialModule : MaterialModule
    {
        ...
        public Color SolidColor { get => Material.GetColor(_waterSolidColorID);
            set => Material.SetColor(_waterSolidColorID, value);
        }

        public Color GradientStartColor { get => Material.GetColor(_waterGradientStartColorID);
            set => Material.SetColor(_waterGradientStartColorID, value);
        }

        public Color GradientEndColor { get => Material.GetColor(_waterGradientEndColorID);
            set => Material.SetColor(_waterGradientEndColorID, value);
        }

        public Color SurfaceColor { get => Material.GetColor(_waterSurfaceColorID);
            set => Material.SetColor(_waterSurfaceColorID, value);
        }
