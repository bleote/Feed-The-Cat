namespace Game2DWaterKit.AttachedComponents
{
    ...
    public class WaterAttachedComponentsModule
    {
        ...
        public BuoyancyEffector2D BuoyancyEffector => _buoyancyEffector;
        public EdgeCollider2D EdgeCollider => _edgeCollider;

        public float BuoyancyEffectorSurfaceLevel
        {
            get => (-_buoyancyEffector.surfaceLevel / _cachedWaterSize.y) + 0.5f;
            set
            {
        ...
        {
            get => _buoyancyEffectorSurfaceLevelLocation;
            set
            {
        ...
        {
            get => _boxColliderTopEdgeLocation;
            set
            {
        ...
        internal bool HasAnimatorAttached => _hasAnimatorAttached;
