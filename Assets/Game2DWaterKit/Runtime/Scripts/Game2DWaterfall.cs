namespace Game2DWaterKit
{
    ...
    public class Game2DWaterfall : Game2DWaterKitObject
    {
        ...
        [SerializeField] private bool _renderingModuleRefractionRenderTextureUseFixedSize;
        ...
        [SerializeField] private int _renderingModuleSortingLayerID;
        [SerializeField] private int _renderingModuleSortingOrder;
        [SerializeField] private float _renderingModuleFarClipPlane = 1000f;
        [SerializeField] private bool _renderingModuleAllowMSAA;
        [SerializeField] private bool _renderingModuleAllowHDR;
        [SerializeField] private bool _renderingModuleRenderPixelLights = true;

        [SerializeField] private bool _isRipplesModuleActive;
        [SerializeField] private bool _ripplesModuleUpdateWhenOffscreen = true;
        [SerializeField] private bool _ripplesModuleRandomizeTimeInterval;
        ...
        #region Properties
        public WaterfallMainModule MainModule => _mainModule;
        public WaterfallRenderingModule RenderingModule => _renderingModule;
        public WaterfallMeshModule MeshModule => _meshModule;
        public WaterfallMaterialModule MaterialModule => _materialModule;
        public WaterfallRipplesModule RipplesModule => _ripplesModule;
        public WaterfallAnimationModule AnimationModule => _animationModule;
        public WaterfallAttachedComponentsModule AttachedComponentsModule => _attachedComponentsModule;
